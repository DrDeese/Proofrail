"""Load fixture 001 and its declared schema from repository files."""
...
def load_fixture_001(repository_root: Path) -> FixtureBundle:
    ...
    fixture_dir = root / "tests" / "fixtures" / "001-partial-workflow-fix"
    ...
    if case.get("id") != "001-partial-workflow-fix":
        raise FixtureLoadError("unexpected fixture case id")
